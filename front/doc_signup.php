...
<script>
    ...
    // جلب عناصر الـ checkboxes
    const clinicCheckbox = document.getElementById('عياده');
    const consultationCheckbox = document.getElementById('استشاره');
    const submitBtn = document.getElementById('submitBtn');
    // const registerForm = document.getElementById('registerform'); // ده مش هنستخدمه لتغيير الـ action

    // دالة لتحديث نص الزرار
    function updateSubmitButtonText() {
        // الشرط هنا كافي: لو العيادة معلمة، حتى لو مع الاستشارة
        if (clinicCheckbox.checked) { 
            submitBtn.textContent = "استكمال البيانات";
        } else {
    ...
    clinicCheckbox.addEventListener('change', updateSubmitButtonText);
    consultationCheckbox.addEventListener('change', updateSubmitButtonText); // برضه لازم نستمع لده عشان لو لغى العيادة و ساب الاستشارة

    // تحديث نص الزرار عند تحميل الصفحة لأول مرة (في حالة لو كان في قيم معلمة مسبقاً)
