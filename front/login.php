...
<div class="logo-container">
      <div class="logo">
        ...
        <!-- رساله محاولة دخول الشات بدون تسجيل -->
        <?php
        // عرض رسالة إذا كانت موجودة في الجلسة
        if (isset($_SESSION['message'])) {
            echo '
            <div class="container mt-4">
            <div class="alert alert-warning alert-dismissible fade show" role="alert" style="text-align: center; direction: rtl;">
                    <strong>تنبيه!</strong> 
                    <i class="fas fa-exclamation-triangle"></i>
                    <span class="message-text">محاولة دخول الشات بدون تسجيل</span>
                    <br>
                    ' . $_SESSION['message'] . '
                    <br>
                    <strong>يرجى تسجيل الدخول أو إنشاء حساب جديد.</strong>
                    <br>
                    <button type="button" class="btn btn-primary" onclick="window.location.href=\'user_signup.php\'">إنشاء حساب جديد</button>
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="alert" aria-label="Close">إغلاق</button>
                </div>
            </div>';
        ...
        <form id="login" action="../pharma_db/registration.php" method="post">
            <label for="email">البريد الإلكتروني</label>
            <div class="input-container">
                <input class="sin" type="email" id="email" name="email" placeholder="البريد الإلكتروني" required dir="rtl" minlength="8">
                <i class="pass_icon fa fa-envelope"></i>
            </div>

            <label for="password">كلمة المرور</label>
            <div class="input-container">
                <input class="sin" type="password" id="password" name="password" placeholder="كلمة المرور" required dir="rtl" minlength="8">
                <i class="fas fa-eye toggle-password" toggle="#password" title="عرض / إخفاء كلمة المرور"></i>
                <i class="pass_icon fa fa-lock" ></i>
            </div>

            <button type="submit" class="a1">الدخول</button>
        
        </form>
        <div class="asks">
            <p>ليس لديك حساب؟ <a href="user_signup.php">إنشاء حساب جديد</a></p>
        </div> 
    </div>
<!-- --------------- End form&logo --------------- -->
