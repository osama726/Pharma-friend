...
<!-- --------------- start navbar --------------- -->
    ...
    <script>
      // تفعيل وإخفاء الروابط عند الضغط على زر "تلت خطوط"
...
<div class="sign-container">
    ...
    <div class="ccu">
      ...
      <?php endif; ?>
      <form class="form" id="registerform" action="../pharma_db/user_registration.php" method="post">
        <label for="first_name">الإسم الأول</label>
        <div class="input-container">
          <input class="sin" type="text" id="first_name" name="first_name" placeholder="الإسم الأول" required>
          <i class="pass_icon fa fa-user"></i>
        </div>
          
        <label for="last_name">الإسم الأخير</label>
        <div class="input-container">
          <input class="sin" class="sin" type="text" id="last_name" name="last_name" placeholder="الإسم الأخير" required>
          <i class="pass_icon fa fa-user"></i>
        </div>
        ...
        <div class="gender-box">
          <label for="ذكر">ذكر</label>
            <input id="ذكر" class="sin" type="radio" name="gender" value="male" />
          <label for="انثي">أنثى</label>
            <input id="انثي" class="sin" type="radio" name="gender" value="female" />
          <div class="trrt"> <i class="fa fa-user"></i></div>
        </div>
          
        <button type="submit" class="buttonm">تسجيل</button>
        <a href="doc_signup.php" class="a1"> تسجيل الدكتور </a>
      </form>
...
<script>
    function validateForm() {
        ...
        var confirm_password = document.forms[0]["confirmpassword"].value;
